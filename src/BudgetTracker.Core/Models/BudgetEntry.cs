...
// Connects to: Models/BudgetCategory.cs, Services/BudgetTrackerService.cs, Services/CsvExportService.cs
// Created: 2026-07-01
...
/// <param name="Category">The category assigned to the transaction.</param>
...
public sealed record BudgetEntry(DateOnly Date, BudgetCategory Category, string Description, decimal Amount);
